	...
	<view class="sWrap">
		...
		<view class="s-box3">
			<view class="s-box3-left">
				...
				<image src="https://ymall-1300255297.cos.ap-hongkong.myqcloud.com/cymall/img/defaultface.png" class="s-box3img" v-else></image>
...
.sWrap{
	.s-box1{
		...
		height: 276rpx;
		/*  #ifdef APP-PLUS || H5 */
		background-image: url("https://ymall-1300255297.cos.ap-hongkong.myqcloud.com/cymall/img/scorebgk.png");
		/*  #endif */
		/*  #ifdef MP-WEIXIN */
