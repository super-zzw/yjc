<template>
	<view class="sWrap">
		<image src="https://xmall-1300255297.cos.ap-guangzhou.myqcloud.com/cymall/img/inviteBgk.png" class="aWrap-bgk" mode="widthFix"></image>
		<view class="sWrap-box">
				...
				<view class="sWrap-buzhou">
					<view class="sWrap-buzhou-item">
						<image class="swbi-img" src="https://xmall-1300255297.cos.ap-guangzhou.myqcloud.com/cymall/img/b1.png" mode=""></image>
					...
					<view class="sWrap-buzhou-item">
						<image class="swbi-img" src="https://xmall-1300255297.cos.ap-guangzhou.myqcloud.com/cymall/img/b2.png" mode=""></image>
						<view class="swbi-tishi">
					...
					<view class="sWrap-buzhou-item">
						<image class="swbi-img" src="https://xmall-1300255297.cos.ap-guangzhou.myqcloud.com/cymall/img/b3.png" mode=""></image>
						<view class="swbi-tishi">
